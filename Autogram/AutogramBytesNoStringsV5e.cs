...
{
    /// <summary>
    /// Based on version 5d, but when randomizing doesn't preserve matching counts.
    /// </summary>
    public class AutogramBytesNoStringsV5e : IAutogramFinder
    {
        ...
        public AutogramBytesNoStringsV5e(
        ...
        private void Randomize()
        {
            ...
            while (true)
            {
                for (int i = 0; i < proposedCounts.Length; i++)
                {
                    ...
                    proposedCounts[i] = OffsetGuess(computedCount, variableMinimumCount[i], randomizationLevel);
                }
