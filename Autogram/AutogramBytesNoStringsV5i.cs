...
{
    /// <summary>
    /// Based on version 5g, but has the variableNumericCounts flattened to [a*b][c].
    /// </summary>
    public class AutogramBytesNoStringsV5i : IAutogramFinder
    {
        ...
        private readonly byte[][] variableNumericCountsFlattened; // Flattened from [a][b][c] to [a*b][c]
        ...
        public AutogramBytesNoStringsV5i(
            ...
            int? randomSeed)
        {
            ...
            variableNumericCountsFlattened = variableNumericCounts.SelectMany(p => p).ToArray();
        ...
        private void UpdateComputedCounts()
        {
            ...
            for (var i = 0; i < variableAlphabetCount; i++)
            {
                ...
                var numericCount = variableNumericCountsFlattened[(i * variableNumericCountStride) + c];
