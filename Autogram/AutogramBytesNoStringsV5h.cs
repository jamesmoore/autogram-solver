...
{
    /// <summary>
    /// Based on version 5g, but accepts a fixed-size byte history key type.
    /// </summary>
    public class AutogramBytesNoStringsV5h<THistoryKey> : IAutogramFinder
        where THistoryKey : struct, IEquatable<THistoryKey>, IByteHistoryKey<THistoryKey>
    {
        private readonly HashSet<THistoryKey> history = [];
        ...
        public AutogramBytesNoStringsV5h(
            ...
            int? randomSeed)
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThan(variableAlphabetCount, THistoryKey.MaxLength);
        ...
        public Status Iterate()
        {
            ...
            var computedKey = THistoryKey.Create(computedCounts);
            ...
            else
            {
                ...
                history.Add(THistoryKey.Create(proposedCounts));
            }
        ...
        private void Randomize()
        {
            ...
            while (true)
            {
                ...
                var proposedKey = THistoryKey.Create(proposedCounts);
