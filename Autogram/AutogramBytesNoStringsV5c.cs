...
{
    /// <summary>
    /// Based on version 5, but uses ByteHistoryKey64.
    /// </summary>
    public class AutogramBytesNoStringsV5c : IAutogramFinder
    {
        ...
        public AutogramBytesNoStringsV5c(
        ...
        private byte[] Randomize()
        {
            ...
            while (true)
            {
                ...
                if (history.Contains(new ByteHistoryKey64(result)) == false)
                {
                    return result;
                }
