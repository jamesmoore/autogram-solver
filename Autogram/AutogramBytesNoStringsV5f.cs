...
{
    /// <summary>
    /// Based on version 5d, but reuses proposed counts array.
    /// </summary>
    public class AutogramBytesNoStringsV5f : IAutogramFinder
    {
        private readonly HashSet<ByteHistoryKey7Bit128> history = [];
        ...
        public AutogramBytesNoStringsV5f(
            ...
            int? randomSeed)
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThan(variableAlphabetCount, ByteHistoryKey7Bit128.MaxLength);
        ...
        public Status Iterate()
        {
            ...
            var computedKey = new ByteHistoryKey7Bit128(computedCounts);
            ...
            else
            {
                ...
                history.Add(new ByteHistoryKey7Bit128(proposedCounts));
            }
        ...
        private void Randomize()
        {
            ...
            while (true)
            {
                ...
                ByteHistoryKey7Bit128 proposedKey = new(proposedCounts);
